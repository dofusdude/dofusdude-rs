...
pub struct CreateAlmanaxWebhookDailySettings {
    ...
    #[serde(rename = "midnight_offset", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub midnight_offset: Option<Option<i32>>,
}

impl CreateAlmanaxWebhookDailySettings {
    pub fn new() -> CreateAlmanaxWebhookDailySettings {
