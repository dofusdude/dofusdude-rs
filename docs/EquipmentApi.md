...
> Vec<models::ListItem> get_items_equipment_search(language, game, query, filter_left_square_bracket_min_level_right_square_bracket, filter_left_square_bracket_max_level_right_square_bracket, limit, filter_left_square_bracket_type_name_id_right_square_bracket)
Search Equipment
...
> models::Weapon get_items_equipment_single(language, ankama_id, game)
Single Equipment
