...
> Vec<models::ListItem> get_items_consumables_search(language, game, query, filter_left_square_bracket_min_level_right_square_bracket, filter_left_square_bracket_max_level_right_square_bracket, limit, filter_left_square_bracket_type_name_id_right_square_bracket)
Search Consumables
...
> models::Resource get_items_consumables_single(language, ankama_id, game)
Single Consumables
